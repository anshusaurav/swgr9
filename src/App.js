        ...
        <div>
          ...
          <div className="absolute top-44 w-75 h-75 left-1/2 mx-auto my-0 transform -translate-y-1/2">
            <svg className="absolute inset-0 mx-auto my-auto animate-rotate origin-center" viewBox="25 25 50 50">
              {/* <circle className="animate-dash stroke-current stroke-3 fill-current" cx="50" cy="50" r="20"
                style={{
              ...
              <circle className="animate-dash" style={{
                strokeDasharray: '1, 200',
                strokeDashoffset: 0,
                strokeLinecap: "round"
              }}
                cx="50" cy="50" r="20" strokeWidth="3" stroke="#fff" fill="none"></circle>
            </svg>
          </div>
        </div>
      </div>
